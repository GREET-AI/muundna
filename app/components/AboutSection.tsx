      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8 break-words">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">
                <NumberTicker value={10} className="text-[#cb530a]" />+ Jahre Erfahrung
              </h3>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center group">
                ...
                <h4 className="font-bold text-gray-800 mb-2">Zeitersparnis</h4>
              ...
              <div className="text-center group">
                <div className="text-4xl mb-3 transform group-hover:scale-110 transition-transform duration-300">💼</div>
                <h4 className="font-bold text-gray-800 mb-2">Professionell</h4>
                <p className="text-gray-600 text-sm">
              ...
              <div className="text-center group">
                <div className="text-4xl mb-3 transform group-hover:scale-110 transition-transform duration-300">📈</div>
                <h4 className="font-bold text-gray-800 mb-2">Wachstum</h4>
                <p className="text-gray-600 text-sm">
