...
export default function DachdeckerZimmerleutePage() {
  return (
    <div className="min-h-screen">
      <main>
        <HeroSection
          ...
          backgroundImage="/images/Dachdecker.png"
        />
        <ExpertiseCTABanner />
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8 border border-gray-200">
                <h2 className="text-3xl font-bold text-gray-800 mb-6">
                  Für Dachdecker & Zimmerleute
                </h2>
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  Als Dachdecker oder Zimmerer arbeiten Sie oft in großer Höhe und benötigen
        ...
        <StatsSection
          ...
          title="Ihre Vorteile als Dachdecker & Zimmerer"
        />
        ...
        <FeaturesGridSection
          ...
          title="Spezialisiert auf Dachdecker & Zimmerleute"
          columns={3}
        />
          ...
          steps={[
            {
              ...
              description: 'Wir analysieren Ihre spezifischen Bedürfnisse als Dachdecker oder Zimmerer',
              icon: '📞'
            },
            {
              number: '2',
